...
package_name = "robo_orchard_piper_ros2"
...
setup(
    ...
    install_requires=["piper_sdk>=0.4.1", "scipy", "numpy"],
    zip_safe=True,
    maintainer="hongyu.xie",
    maintainer_email="hongyu.xie@horizon.auto",
    description="The ros2 package of piper control.",
    license="Apache-2.0",
    tests_require=["pytest"],
    entry_points={
        "console_scripts": [
            "aloha_raw_ctrl = robo_orchard_piper_ros2.aloha_raw:main",  # noqa: E501
            "aloha_ctrl = robo_orchard_piper_ros2.aloha:main",  # noqa: E501
            "single_ctrl = robo_orchard_piper_ros2.single:main",  # noqa: E501
        ],
    },
)
