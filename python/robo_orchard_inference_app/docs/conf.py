...
from doc_gen import gen_index  # type: ignore
from recommonmark.parser import CommonMarkParser
from recommonmark.transform import AutoStructify

import robo_orchard_inference_app

CUR_DIR = os.path.abspath(os.path.dirname(__file__))

# -- Project information -----------------------------------------------------

project = "RoboOrchardInferenceApp"
copyright = "2024-2026, Horizon Robotics Developers"
author = "Horizon Robotics Developers"

# # The short X.Y version
version = robo_orchard_inference_app.__version__
release = robo_orchard_inference_app.__version__
...
html_context = {
    ...
    "versions_json_url": os.getenv(
        ...
        "https://horizonrobotics.github.io/robot_lab/robo_orchard/inference_app/version.json",
    ),
}
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/HorizonRobotics/roboorchard",
            "html": """
...
htmlhelp_basename = "RoboOrchardInferenceApp"
...
man_pages = [
    (master_doc, "RoboOrchardInferenceApp", "Documentation", [author], 1)
]
